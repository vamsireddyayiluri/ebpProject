...
<template>
  ...
  <template>
    <Dialog ref="memberDialog" width="50%" min-width="400px">
      ...
      <template #actions>
        <Button block variant="plain" @click="removeMember(removedMember.id)"> Remove </Button>
      </template>
    </Dialog>
  </template>
  ...
  <template>
    <Dialog ref="locationDialog" width="50%" min-width="400px">
      ...
      <template #actions>
        <Button block variant="plain" @click="removeLocation(removedLocation.id)"> Remove </Button>
      </template>
    </Dialog>
  </template>
</template>
